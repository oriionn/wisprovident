...
function Comprehensions(props) {
    ...
    async function deleteComprehension(e: any) {
    ...
    return (<>
        ...
        <Dialog modalType="non-modal">
            <DialogTrigger disableButtonEnhancement>
                <Button>Ajouter une compréhension</Button>
            </DialogTrigger>
            <DialogSurface>
                <DialogBody>
                    <DialogTitle>Ajouter un compréhensions</DialogTitle>
                    <DialogContent className={styles.modal_content}>
                        <Label required htmlFor={"name"}>
                            Nom de la compréhensions
                        </Label>
                        <Input required type="text" id={"name"} />
                        <Label required htmlFor={"link"}>
                            Lien de la compréhensions
                        </Label>
                    ...
                    <DialogActions>
                        ...
                        <Button onClick={createComprehension} appearance="primary">
                            Créer la compréhensions
                        </Button>
                    </DialogActions>
                </DialogBody>
            </DialogSurface>
                    ...
                    data.map((item, i) => {
                        if (item !== undefined || !item.link) return (
                            <TableRow data-id={i} key={i}>
                                ...
                                <TableCell>
                                    <Button onClick={deleteComprehension} data-id={i} icon={<DeleteRegular data-id={i} />} aria-label="Supprimer" />
                                </TableCell>
                            </TableRow>
                        );
                    })
